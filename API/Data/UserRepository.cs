...
namespace API.Data
{
  public class UserRepository : IUserRepository
  {
    ...
    /* 
    more efficient to get a member
     */
    ...
    /* 
    more efficient way of returning members
     */
    public async Task<PagedList<MemberDto>> GetMembersAsync(UserParams userParams)
    {
      var query = _context.Users.AsQueryable();

      // filtering by logged in user and gender
    ...
    {
      // make sure greater than 0 changes have been saved
